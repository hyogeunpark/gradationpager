...
```xml
<com.hyogeum.gradationpager.GradationViewPager
...
viewPager.setAdapter(new PagerAdapter()); // your adapter
viewPager.setBackgroundColors(colors); // colors is int array(new int[])
```
...
viewPager.setBackGroundColors(colors)
```
...
<android.support.constraint.ConstraintLayout
    ...
    <android.support.design.widget.AppBarLayout
        ...
        <com.hyogeum.gradationpager.InfiniteTabLayout
...
```java
ViewPager viewPager = (ViewPager) findViewById(R.id.viewpager);
InfiniteTabLayout tabLayout = (InfiniteTabLayout) findViewById(R.id.tab_layout)
PagerAdapter adapter = new PagerAdapter() // your custom adapter(* must declare getTitlePage() *)
